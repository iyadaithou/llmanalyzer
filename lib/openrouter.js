...
export const CURATED_MODELS = [
  // OpenAI — `gpt-5*:online` uses OpenRouter's Exa web plugin (cheaper search
  // than the bundled `gpt-4o-*-search-preview` line, which charges $0.0275 -
  // $0.035 per request for OpenAI's own search). Keep both for now so we can
  // compare native-search ChatGPT vs Exa-augmented GPT-5.
  { id: "openai/gpt-5-mini:online",            label: "GPT-5 mini",            vendor: "OpenAI",     kind: "web", tier: "cheap",   note: "GPT-5 mini + Exa web" },
  { id: "openai/gpt-5:online",                 label: "GPT-5",                 vendor: "OpenAI",     kind: "web", tier: "premium", note: "GPT-5 + Exa web" },
  { id: "openai/gpt-4o-mini-search-preview",   label: "ChatGPT Search (mini)", vendor: "OpenAI",     kind: "web", tier: "premium", note: "GPT-4o-mini + native web search" },
  ...
  { id: "anthropic/claude-haiku-4.5:online",   label: "Claude Haiku 4.5",      vendor: "Anthropic",  kind: "web", tier: "cheap",   note: "Exa web search" },
  ...
  { id: "google/gemini-2.5-flash:online",      label: "Gemini 2.5 Flash",      vendor: "Google",     kind: "web", tier: "cheap",   note: "Exa web search" },
