 ...
 * + visible content tokens both come out of this pool. For a research-grade
 * answer with web grounding, 2048 isn't enough headroom; the visible output
 * gets squeezed even with "low" effort. 4096 leaves ~3000+ for content
 * after typical low-effort reasoning.
 */
export const OPENAI_REASONING_MIN_BUDGET = 4096;
